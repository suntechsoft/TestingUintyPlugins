...
namespace ICODES.STUDIO.WWebView
{
#endif
    /// <summary>
    /// A plugin wrapper class that supports the Windows Standalone platform.
    /// This class is only activated on Windows Standalone platform.
    /// </summary>
...
#endif
    {
        ...
        private static void OnBeforeNavigate(IntPtr name, IntPtr url, IntPtr message, ref bool cancel)
        {
            ...
            if (webView != null)
            {
                ...
                if (string.IsNullOrEmpty(customMessage) == false)
                {
                    ...
                    if (customMessage == "_btnClose" || customMessage == "_btnClose/")
        ...
        /// </summary>
        /// <param name="name">Target(event dispatcher) identifier.</param>
        /// <param name="cancel">Decides whether to actually _btnClose or not.</param>
