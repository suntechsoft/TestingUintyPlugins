...
public class WWebViewDemo : MonoBehaviour
{
    ...
    public string html =
        ...
        <p><a href='wwebview://_btnClose/'>wwebview://_btnClose/</a></p>
        <p><a href='javascript:window._btnClose();'>window._btnClose() - works only on Win32 Webview</a></p>
    ...
    public void Texturing()
    {
        ...
        Hide();
        webView.Navigate("https://youtu.be/ctNF6QlLBWo");
